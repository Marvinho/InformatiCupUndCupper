...
def testing(epoch, best_accuracy, model = model, criterion = criterion):
    print("---------- Testing Phase ----------")
    model.eval()
    with torch.no_grad():
...
#    print('Accuracy of the network on the test images: {}'.format(epoch_accuracy))
    ...
    if(epoch_accuracy > best_accuracy):
        ...
        torch.save(model.state_dict(), "saved_model_state_alexnet_epoch_{}accuracy_{:.2f}.pth"
